package spring_rabbitmq.topic_exchange.config;

import org.springframework.amqp.core.*;
import org.springframework.context.annotation.Bean;
import org.springframework.context.annotation.Configuration;
import spring_rabbitmq.topic_exchange.TopicExchangeMessageListener1;
import spring_rabbitmq.topic_exchange.TopicExchangeMessageListener2;

@Configuration
public class TopicExchangeRabbitMqConfig {
    private static final String EXCHANGE_NAME = "com.kmurawska.playground.spring_rabbitmq.topic_exchange";
