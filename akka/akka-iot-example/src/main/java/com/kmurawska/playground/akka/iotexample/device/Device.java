...
public class Device extends AbstractActor {
    ...
    private void onTrackDeviceRequest(TrackDeviceRequest r) {
    ...
    private boolean groupAndDeviceMatch(TrackDeviceRequest r) {
    ...
    private void onReadTemperature(ReadTemperature r) {
        getSender().tell(new DeviceTemperatureResponse(r.getTrackingId(), lastTemperatureReading), getSelf());
    }
